...
#
# Generated by export_simulation on Fri Oct 06 11:29:36 +0100 2023
#
################################################################################
...
'-reset_run' switch to the './FullAdder_4bits_tb.sh' script.

./FullAdder_4bits_tb.sh -reset_run
...
./FullAdder_4bits_tb.sh -noclean_files

For more information on the script, please type './FullAdder_4bits_tb.sh -help'.
